                                    ...
                                    <tr>
                                      ...
                                      <td>
                                        <div class="col-md-6" style="margin-top:5px;">
                                           <a href="<?php echo base_url();?>index.php/sise/asigna/<?php echo str_replace(" ", "_", $oferta->nombre_of_aca) ; ?>">
                                    ...
                                    <?php foreach ($grupos as $grupo){ ?>
                                      <tr>
                                        ...
                                        <td><?php echo $grupo->nombres_personal." ".$grupo->ap_paterno_personal." ".$grupo->ap_materno_personal;?></td>
                            		        <td>
                                          <div class="col-md-6" style="margin-top:5px;">
                                            <form method="post" action="<?php echo base_url();?>index.php/sise/ver_asignatura/">
